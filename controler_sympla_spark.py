...
from packages.sympla_spark_data_extractor_package.sympla_data_loader import DataLoaderSymplaSpark
...
data_loader_sympla = DataLoaderSymplaSpark(folder_path=dados_sympla_eventos_path, database_uri=database_sympla_and_ibge_uri)
